...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, getRouterParam, getQuery as getQuery$1, readBody, getResponseStatusText } from 'file:///Applications/XAMPP/xamppfiles/htdocs/MendyApp/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Applications/XAMPP/xamppfiles/htdocs/MendyApp/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Applications/XAMPP/xamppfiles/htdocs/MendyApp/node_modules/devalue/index.js';
import destr from 'file:///Applications/XAMPP/xamppfiles/htdocs/MendyApp/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash } from 'file:///Applications/XAMPP/xamppfiles/htdocs/MendyApp/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///Applications/XAMPP/xamppfiles/htdocs/MendyApp/node_modules/vue/server-renderer/index.mjs';
import { hash } from 'file:///Applications/XAMPP/xamppfiles/htdocs/MendyApp/node_modules/ohash/dist/index.mjs';
import { renderSSRHead } from 'file:///Applications/XAMPP/xamppfiles/htdocs/MendyApp/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Applications/XAMPP/xamppfiles/htdocs/MendyApp/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///Applications/XAMPP/xamppfiles/htdocs/MendyApp/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Applications/XAMPP/xamppfiles/htdocs/MendyApp/node_modules/hookable/dist/index.mjs';
import { klona } from 'file:///Applications/XAMPP/xamppfiles/htdocs/MendyApp/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file:///Applications/XAMPP/xamppfiles/htdocs/MendyApp/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file:///Applications/XAMPP/xamppfiles/htdocs/MendyApp/node_modules/defu/dist/defu.mjs';
import { createStorage, prefixStorage } from 'file:///Applications/XAMPP/xamppfiles/htdocs/MendyApp/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Applications/XAMPP/xamppfiles/htdocs/MendyApp/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Applications/XAMPP/xamppfiles/htdocs/MendyApp/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file:///Applications/XAMPP/xamppfiles/htdocs/MendyApp/node_modules/consola/dist/index.mjs';
import devalue from 'file:///Applications/XAMPP/xamppfiles/htdocs/MendyApp/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { getContext } from 'file:///Applications/XAMPP/xamppfiles/htdocs/MendyApp/node_modules/unctx/dist/index.mjs';
import { fileURLToPath } from 'node:url';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file:///Applications/XAMPP/xamppfiles/htdocs/MendyApp/node_modules/ipx/dist/index.mjs';
import { isAbsolute } from 'file:///Applications/XAMPP/xamppfiles/htdocs/MendyApp/node_modules/pathe/dist/index.mjs';
import { version, unref } from 'file:///Applications/XAMPP/xamppfiles/htdocs/MendyApp/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///Applications/XAMPP/xamppfiles/htdocs/MendyApp/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Applications/XAMPP/xamppfiles/htdocs/MendyApp/node_modules/@unhead/shared/dist/index.mjs';
...
const _inlineRuntimeConfig = {
  ...
  "ipx": {
    ...
    "fs": {
      "dir": [
        "/Applications/XAMPP/xamppfiles/htdocs/MendyApp/public"
      ]
    },
    "http": {
      "domains": [
...
const serverAssets = [{"baseName":"server","dir":"/Applications/XAMPP/xamppfiles/htdocs/MendyApp/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Applications/XAMPP/xamppfiles/htdocs/MendyApp","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Applications/XAMPP/xamppfiles/htdocs/MendyApp/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Applications/XAMPP/xamppfiles/htdocs/MendyApp/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Applications/XAMPP/xamppfiles/htdocs/MendyApp/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Applications/XAMPP/xamppfiles/htdocs/MendyApp/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _JSc9tWCILk = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script$1}<\/script>`);
  });
});

const rootDir = "/Applications/XAMPP/xamppfiles/htdocs/MendyApp";

const asyncContext = getContext("nuxt-dev", { asyncContext: true, AsyncLocalStorage });
const _2MnQ1sSbtz = (nitroApp) => {
...
const _XjnT0A8N7H = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
...
const _E7NLCA = lazyEventHandler(() => {
...
const _lazy_PH3fDN = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_PH3fDN, lazy: true, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _E7NLCA, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_PH3fDN, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file:///Applications/XAMPP/xamppfiles/htdocs/MendyApp/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Applications/XAMPP/xamppfiles/htdocs/MendyApp/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
